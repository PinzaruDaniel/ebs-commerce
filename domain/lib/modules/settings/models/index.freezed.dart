...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SettingsEntity&&(identical(other.hasAgreedTerms, hasAgreedTerms) || other.hasAgreedTerms == hasAgreedTerms));
}
...
/// Create a copy of SettingsEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? hasAgreedTerms = null,}) {
  return _then(_self.copyWith(
hasAgreedTerms: null == hasAgreedTerms ? _self.hasAgreedTerms : hasAgreedTerms // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool hasAgreedTerms)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SettingsEntity() when $default != null:
return $default(_that.hasAgreedTerms);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool hasAgreedTerms)  $default,) {final _that = this;
switch (_that) {
case _SettingsEntity():
return $default(_that.hasAgreedTerms);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool hasAgreedTerms)?  $default,) {final _that = this;
switch (_that) {
case _SettingsEntity() when $default != null:
return $default(_that.hasAgreedTerms);case _:
  return null;
...
class _SettingsEntity implements SettingsEntity {
  const _SettingsEntity({required this.hasAgreedTerms});
  

@override final  bool hasAgreedTerms;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SettingsEntity&&(identical(other.hasAgreedTerms, hasAgreedTerms) || other.hasAgreedTerms == hasAgreedTerms));
}
...
/// Create a copy of SettingsEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? hasAgreedTerms = null,}) {
