...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
    id: const obx_int.IdUid(1, 6833820677768444676),
    name: 'CategoryBox',
    lastPropertyId: const obx_int.IdUid(5, 3029077568951643689),
    flags: 0,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 2708480963019139131),
        name: 'idCategory',
        type: 6,
        flags: 129,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(2, 7330556027562734858),
        name: 'name',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(3, 7393189180196623986),
        name: 'level',
        type: 6,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(4, 4007947637346629996),
        name: 'parent',
        type: 6,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(5, 3029077568951643689),
        name: 'productId',
        type: 11,
        flags: 520,
        indexId: const obx_int.IdUid(1, 59087588538357296),
  ...
  obx_int.ModelEntity(
    id: const obx_int.IdUid(2, 4498423639696778517),
    name: 'DeliveryAddressBox',
    lastPropertyId: const obx_int.IdUid(9, 3406394164296495520),
    flags: 0,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 4601079462103699576),
        name: 'id',
        type: 6,
        flags: 129,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(2, 8386348085142683691),
        name: 'deliveryType',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(3, 3061257712162767708),
        name: 'comments',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(4, 2454480190625756454),
        name: 'pickupLocation',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(5, 3983657272953688071),
        name: 'country',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(6, 6029903823160417047),
        name: 'region',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(7, 5342774053796817737),
        name: 'city',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(8, 6703029228681384289),
        name: 'postalCode',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(9, 3406394164296495520),
        name: 'address',
        type: 9,
        flags: 0,
      ),
  ...
  obx_int.ModelEntity(
    id: const obx_int.IdUid(3, 3262990880602336421),
    name: 'PaymentMethodBox',
    lastPropertyId: const obx_int.IdUid(3, 4928082698846043451),
    flags: 0,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 4164715177199326311),
        name: 'id',
        type: 6,
        flags: 129,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(2, 1499830996465277119),
        name: 'key',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(3, 4928082698846043451),
        name: 'titleKey',
        type: 9,
        flags: 0,
      ),
  ...
  obx_int.ModelEntity(
    id: const obx_int.IdUid(4, 5804068166779189608),
    name: 'ProductBox',
    lastPropertyId: const obx_int.IdUid(9, 4429681976866699380),
    flags: 0,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 3188694929195359074),
        name: 'idProduct',
        type: 6,
        flags: 129,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(2, 7228603354429288158),
        name: 'name',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(3, 4735700627054348836),
        name: 'price',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(4, 5458899917760569618),
        name: 'discount',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(5, 6752632406341757518),
        name: 'discountedPrice',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(6, 4317797700941553287),
        name: 'imageUrl',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(7, 3217432874708796045),
        name: 'marks',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(8, 4210558235208119769),
        name: 'stock',
        type: 6,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(9, 4429681976866699380),
        name: 'description',
        type: 9,
        flags: 0,
      ),
  ...
  obx_int.ModelEntity(
    id: const obx_int.IdUid(5, 5891861883004090648),
    name: 'SpecificationBox',
    lastPropertyId: const obx_int.IdUid(5, 6754340702794044333),
    flags: 0,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 5149959930373772646),
        name: 'idSpec',
        type: 6,
        flags: 129,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(2, 8330738716360487640),
        name: 'attributeId',
        type: 6,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(3, 2742851674008223245),
        name: 'attributeName',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(4, 2609103011837157825),
        name: 'value',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(5, 6754340702794044333),
        name: 'productId',
        type: 11,
        flags: 520,
        indexId: const obx_int.IdUid(2, 2455165691226351570),
        relationTarget: 'ProductBox',
      ),
    ],
    relations: <obx_int.ModelRelation>[],
  ...
  obx_int.ModelEntity(
    id: const obx_int.IdUid(6, 6943475854534566469),
    name: 'UserBox',
    lastPropertyId: const obx_int.IdUid(8, 43478454090277344),
    flags: 0,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 363115835817515750),
        name: 'id',
        type: 6,
        flags: 129,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(2, 3556976681081683567),
        name: 'name',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(3, 275900586924987690),
        name: 'surname',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(4, 2331189600810540079),
        name: 'number',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(5, 3757833726518460180),
        name: 'dialCode',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(6, 6286690790477418275),
        name: 'email',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(7, 2646500726833928815),
        name: 'deliveryAddressBoxId',
        type: 11,
        flags: 520,
        indexId: const obx_int.IdUid(3, 2639470921583169366),
        relationTarget: 'DeliveryAddressBox',
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(8, 43478454090277344),
        name: 'paymentMethodBoxId',
        type: 11,
        flags: 520,
        indexId: const obx_int.IdUid(4, 5998382651222191652),
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
    entities: _entities,
    lastEntityId: const obx_int.IdUid(6, 6943475854534566469),
    lastIndexId: const obx_int.IdUid(4, 5998382651222191652),
