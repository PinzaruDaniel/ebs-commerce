...
part of 'specification_api_dto.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SpecificationApiDto&&(identical(other.title, title) || other.title == title)&&(identical(other.value, value) || other.value == value));
}
...
@override
String toString() {
  return 'SpecificationApiDto(title: $title, value: $value)';
}
...
class _SpecificationApiDto implements SpecificationApiDto {
  const _SpecificationApiDto({required this.title, required this.value});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SpecificationApiDto&&(identical(other.title, title) || other.title == title)&&(identical(other.value, value) || other.value == value));
}
